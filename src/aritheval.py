...
class EAConstDiv(BaseEvalGate):
	...
	def eval_internal(self, ae):
		input = ae.lookup(self.wire_id)
		# print("input//self.const",input,self.const, input//self.const)
		return input//self.const
...
class EADiv(BaseEvalOp):
	def __init__(self, wire_list):
		BaseEvalOp.__init__(self, wire_list, operator.floordiv)
